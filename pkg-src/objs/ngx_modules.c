...
extern ngx_module_t  ngx_handoff_module;
extern ngx_module_t  ngx_handoff_core_module;
extern ngx_module_t  ngx_filter_module;
...
extern ngx_module_t  ngx_http_preload_filter_module;
...
ngx_module_t *ngx_modules[] = {
    ...
    &ngx_tcp_ssl_module,
    &ngx_handoff_module,
    &ngx_handoff_core_module,
    &ngx_filter_module,
    &ngx_filter_core_module,
    &ngx_openssl_module,
    &ngx_regex_module,
    &ngx_http_module,
    ...
    &ngx_http_preload_filter_module,
