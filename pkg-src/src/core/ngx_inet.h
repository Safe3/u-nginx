...
#if (NGX_HAVE_INET6)
char* ngx_parse_host_port6(ngx_log_t *log, ngx_str_t *value, struct in6_addr *o_host, in_port_t *o_port, struct in6_addr dehost);
#endif
char* ngx_parse_host_port(ngx_log_t *log, ngx_str_t *value, struct in_addr *o_host, in_port_t *o_port, in_addr_t dehost);
